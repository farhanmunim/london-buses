...
/* ── manifest.json ───────────────────────────────────────────────────── */
{
  const DATASET_META = {
    ...
    'fleet':            { source: 'TfL arrivals sweep + DVLA VES', cadence: 'every 8 hours (07:20/15:20/23:20 UTC)' },
    'vehicles':         { source: 'TfL arrivals sweep + DVLA VES', cadence: 'every 8 hours (07:20/15:20/23:20 UTC)' },
    'tenders':          { source: 'TfL tender results (13923/13796.aspx)', cadence: 'hourly 07:20–20:20 UTC (TfL publishes ~1pm/3pm)' },
