...
import { filterOverview, filterGarages, getVisibleRouteProps, countVisibleGarages } from './map.js?v=2.16.7';
import { fetchStopsRegistry } from './api.js?v=2.16.7';
import { state, routeCountEl, mobRoutesEl,
         clearRouteFiltersBtn, clearGarageFiltersBtn, resetAllBtn } from './state.js?v=2.16.7';
import { renderOperatorStats } from './stats.js?v=2.16.7';
import { showRpTab } from './panels.js?v=2.16.7';
