...
import { filterOverview, filterGarages, getVisibleRouteProps, countVisibleGarages } from './map.js?v=2.15.2';
import { fetchStopsRegistry } from './api.js?v=2.15.2';
import { state, routeCountEl, mobRoutesEl,
         clearRouteFiltersBtn, clearGarageFiltersBtn, resetAllBtn } from './state.js?v=2.15.2';
import { renderOperatorStats } from './stats.js?v=2.15.2';
