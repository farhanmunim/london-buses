      ...
      <div class="modal-panel">
        ...
        <section class="modal-section">
          ...
          <p class="modal-note" style="margin-top: 0; padding: 0 var(--sp-3);">
            All data comes from this site's own open pipeline — GitHub Actions fetches, validates and commits the datasets, and the site serves them as static JSON. Upstream sources: Transport for London (routes, stops, geometry, service status, diversions, crowding, live arrivals) — <strong>Powered by TfL Open Data</strong>. Contains OS data © Crown copyright and database rights 2016 and Geomni UK Map data © and database rights 2019. Live bus positions from the DfT Bus Open Data Service; vehicle make, year and fuel from the DVLA Vehicle Enquiry Service — contains public sector information licensed under the <a href="https://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank" rel="noopener">Open Government Licence v3.0</a>. Operators, garages, PVR and vehicle types courtesy of londonbusroutes.net (community reference). Basemap © <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener">OpenStreetMap</a> contributors (ODbL), tiles © <a href="https://carto.com/attributions" target="_blank" rel="noopener">CARTO</a>.
          </p>
        </section>
